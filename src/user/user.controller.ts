...
export class UserController {
  ...
  @ApiBearerAuth()
  async chatRoomFindJoined(@Req() req: RequestWithUser) {
    ...
    const hostChatList = await this.userChatRoomService.userChatRoomHosted(
      user.id,
    );
  ...
  @ApiBearerAuth()
  async chatRoomFindHosted(@Req() req: RequestWithUser) {
    ...
    const userChatJoinList = await this.userChatRoomService.userChatRoomJoin(
      user.id,
    );
